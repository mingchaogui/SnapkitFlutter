...
const String _kMethodChannelName =
    'plugins.mintinglabs.com/snapkit_flutter_android';

class SnapkitFlutterAndroid extends SnapkitFlutterPlatform {
  ...
  static void registerWith() {
    ...
    // interface.
    SnapkitFlutterPlatform.instance = SnapkitFlutterAndroid();
  }
